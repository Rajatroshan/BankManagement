...
public class details extends javax.swing.JFrame {
  ...
  public void text(int a){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     if(jTextField3.getText().equals("") && jTextField4.getText().equals("") && jTextField2.getText().equals("") && jTextField1.getText().equals(""))
     {
        ...
        else
        {
            try{
                                              ...
                                              try {
                                                  ...
                                                  message.setSubject("INITIATING THE ATM CARD");
                                                  message.setText("Hey Customer,"+"\nYou are applying ATM card It will be initiated."+"\nOur BANK AGENT We will be reachout SOON....!!!"+"\nYOUR GIVEN DETAILS ARE :"
                          ...
                          String query="insert into atmapply values ('"+un+"','"+em+"','"+ph+"','"+ad+"')";//insert into loan values ('rajat','djv',);
